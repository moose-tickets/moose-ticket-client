  ...
  private handleNotificationResponse(response: Notifications.NotificationResponse) {
    ...
    if (this.navigationRef?.isReady()) {
      if (data.ticketId) {
        ...
        // Navigate to dispute details in tickets section
        this.navigationRef.dispatch(
          CommonActions.navigate('Main', {
            screen: 'Tickets',
            params: {
              screen: 'TicketDisputeStatus',
              params: { ticketId: data.disputeId }
            }
          })
        );
      ...
      console.log('Navigation not ready, storing notification for later:', data);
    }
  }
